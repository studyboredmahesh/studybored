    ...
    <div className="home">
      ...
      <div className="container">
        ...
        <div class="row align-items-center my-3">
          ...
          <div class="col-lg-5">
          <Box className="report" boxShadow={2}>
               
               <div className="descriptn">Continuing Studybored project</div>
               <div className="srcnshot">
                 <img src="screenshot.png" className="srcnshot"></img>
               </div>
             <Box className="date" style={{bottom: 95}}><div className="date1">
             Tuesday, March 9th
               </div></Box>  
             </Box>
             <br/><br/>
             <Box className="report" boxShadow={2}>
               ...
               <div className="descriptn">Continuing ui/ux designing</div>
               <div className="srcnshot">
                 <img src="screenshot.png" className="srcnshot"></img>
               </div>
             <Box className="date" style={{bottom: 95}}><div className="date1">
